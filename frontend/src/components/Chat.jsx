...
const [changed, setchanged] = useState(false);
    ...
    const ENDPOINT = 'https://friends-book-social-media.vercel.app/'
...
useEffect(()=>{
    const createConversation =async()=>{
        let res = await fetch('https://friends-book-social-media.vercel.app/api/conversation/create',{
            method: 'POST',
            headers:{
...
const handleSendMessage = async()=>{
   ...
   socket.emit('sendMessage',{
    ...
    let res = await fetch(`https://friends-book-social-media.vercel.app/api/messages/create`,{
        method: 'POST',
        headers: {
            'content-type': 'application/json',
        },
