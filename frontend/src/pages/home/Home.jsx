...
const Home = () => {
  ...
  const handlePost =async()=>{
    ...
    let response = await fetch('https://friends-book-social-media.vercel.app/api/posts/create',{
      method:"POST",
      headers:{
  ...
  useEffect(()=>{
    const fetchTimeLinePost = async()=>{
      let res = await fetch('https://friends-book-social-media.vercel.app/api/users/timeLinePosts',{
        method: 'POST',
