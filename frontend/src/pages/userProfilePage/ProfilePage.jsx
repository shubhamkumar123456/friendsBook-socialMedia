...
useEffect(()=>{
    ...
    const handleDelete =async(post)=>{
        ...
        let response = await fetch('http://friends-book-social-media.vercel.app/api/posts/delete',{
            method: 'DELETE',
            headers:{
    ...
    const profileSubmitHandler=async()=>{
        let response = await fetch('http://friends-book-social-media.vercel.app/api/posts/updateProfilePic',{
            method:"PUT",
            headers:{
                'content-type':'application/json'
            },
    ...
    const updateCoverPic = async()=>{
         let response = await fetch('http://friends-book-social-media.vercel.app/api/posts/updateCoverPic',{
            method:"PUT",
            headers:{
                'content-type':'application/json'
            },
